    ...
    <body>
        <table class="table">
            <thead>
    <tr>
        <th style="text-align: center;background-color: blue;color:yellow;width: 250px;">Nombre de usuario</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 180px;">Puesto</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 180px;">Modelo</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">Ghz</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">Disco</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">GEKO</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 150px;">Clave Telefonica</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">IP</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 150px;">SIF</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">POC</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">NADCOM</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">SAGA</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 200px;">Grupo Fortinet</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 100px;">VNC</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 180px;">Antivirus</th>
        <th style="text-align: center;background-color: blue;color:yellow;width: 200px;">Office</th>
        ...
        <th style="text-align: center;background-color: blue;color:yellow;width: 140px;">Regulador</th>
